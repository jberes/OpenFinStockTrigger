    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            _runtime.Connect(() =>
            {
                ...
                var appOptions = new Openfin.Desktop.ApplicationOptions("IGFinTickerWPFDemo",
                    "IGFinTickerWPFDemo-" + guid, "https://www.infragistics.com/openfin");
        ...
        {           
           ...
           // _runtime.InterApplicationBus.Send("", "FDC3", jsonObj);
           //_runtime.InterApplicationBus.Send("appid", "topic", "Hello there!");
